...
# Enhanced multi-trial benchmarking with memory and CPU metrics
...
# Display summary if Python with pandas is available
...
PYTHON
  ...
  echo "Install Python 3 to see summary statistics"
  cat "$OUTPUT_FILE"
fi
